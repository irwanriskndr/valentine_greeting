...
class WebScreen4 extends StatefulWidget {
  const WebScreen4({Key? key}) : super(key: key);

  @override
  State<WebScreen4> createState() => _WebScreen4State();
}

class _WebScreen4State extends State<WebScreen4> {
  final urlImages = [
    'assets/1.png',
    'assets/2.png',
    'assets/3.png',
